...
const faq = [
  {
    ...
    answer: 'В последний день практики, который указан в LMS. Раньше сдавать нельзя: откройте задание в этот день, прикрепите актуальный комплект и отправьте его до времени закрытия, если оно указано.',
  },
  {
    category: 'Сдача',
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-5 py-7 sm:px-8 lg:grid-cols-[1.12fr_.88fr] lg:py-10">
        <div className="relative overflow-hidden rounded-[30px] bg-primary p-6 text-black sm:p-9">
          ...
          <p className="relative mt-4 text-sm font-semibold">Сдавать можно только в последний день практики в LMS. Раньше — нельзя.</p>
        </div>
